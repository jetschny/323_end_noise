...
base_in_folder_tif: str ="Z:/NoiseML/2024/city_data_raw/"
base_in_folder_npy: str ="Z:/NoiseML/2024/city_data_MLpredictions/"
base_out_folder:    str ="Z:/NoiseML/2024/city_data_MLpredictions/"
base_out_folder_pic :    str ="Z:/NoiseML/2024/city_data_MLpredictions/"
...
grid1=np.load(base_in_folder_npy+city_string_in+"/" +city_string_out+in_file_npy)
...
if plot_switch:
    ...
    plt.savefig(base_out_folder_pic +city_string_in+"/"+city_string_out+out_file_png)
    plt.show()
