...
in_grid_file5="OSM_roads_han_nlanes_clipfilldist.npy"
# in_grid_file6="OSM_roads_bcn_maxspeed_clip_smooth.npy"
in_grid_file6="OSM_roads_han_maxspeed_clipfilldist.npy"
# in_grid_file7="bcn_road_focalstats50_clip.npy"
# in_grid_file7="OSM_roads_han_maxspeed_clipfill.npy"
...
if plot_switch:
    ...
    grid_target_crop=grid_target[0:-1,0:-1]
    ...
    y_slice=800
    plot1=axs1.plot([0,1900],[y_slice, y_slice],'-r')
    ...
    grid7_plot=np.zeros(grid_target.shape)
    ...
    grid7_plot[indexxy]=grid7[indexxy]
    
    # plot4=axs1.plot(grid4_plot[y_slice,:],"-m")
    plot4=axs1.plot(grid4_plot[y_slice,:],"-k")
    plot5=axs1.plot(grid5_plot[y_slice,:],"-c")
    plot6=axs1.plot(grid6_plot[y_slice,:],"-y")
    
    
    plt.legend(['OSM Street Class', 'OSM Number of Lanes', 'OSM Speet Limit'], loc="upper left")
    
    axs2=axs1.twinx()
    
    plot_target=axs2.plot(grid_target[y_slice,:],"-r")
    # plot1=axs1.plot(grid1_plot[y_slice,:]/np.max(grid1_plot[y_slice,:]),"-b")
    # plot2=axs1.plot(grid2_plot[y_slice,:]/np.max(grid2_plot[y_slice,:]),"-g")
    # plot3=axs1.plot(grid3_plot[y_slice,:]/np.max(grid3_plot[y_slice,:]),"-y")
    ...
    axs1.set_ylabel("OSM",fontsize=14)
