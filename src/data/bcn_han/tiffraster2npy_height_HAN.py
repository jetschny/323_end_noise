...
in_file  = 'DE013_HANNOVER_UA2012_DHM_V010/Dataset/DE013_HANNOVER_UA2012_DHM_V010.tif'
out_file = "DE013_HANNOVER_UA2012_DHM_V010_buildingheight"
...
if interp_switch:
    img_clipped = np.resize(np.squeeze(img_clipped),(1500,1500))
