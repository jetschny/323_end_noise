...
in_grid_file1="ES002_BARCELONA_UA2012_DHM_V010_buildingheight_clip.npy"

grid1=np.load(base_in_folder+in_grid_file1)

write_switch=True
out_grid_file="bcn_distance2buildings_bcd"
...
if write_switch:
    ...
    out_grid_file=base_in_folder+out_grid_file+".npy"
