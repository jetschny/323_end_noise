...
def calculate_ssim_between_cities(city1_data, city2_data):
    ...
    for i, feature in enumerate(features):
        ...
        score = ssim(np.squeeze(city1_data[i,:min_shape[0], :min_shape[1]]), 
                     np.squeeze(city2_resampled[i,:min_shape[0], :min_shape[1]]), 
                     data_range=city2_resampled[i,:min_shape[0], :min_shape[1]].max() - city2_resampled[i,:min_shape[0], :min_shape[1]].min())
