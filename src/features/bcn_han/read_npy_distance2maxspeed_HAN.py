...
in_file="OSM_roads_han_maxspeed_clipfill.npy"
out_file="OSM_roads_han_maxspeed_clipfilldist"
...
y_slice=800 
plot1=ax1.plot([0,1900],[y_slice, y_slice],'-r')
plot1=ax2.plot([0,1900],[y_slice, y_slice],'-r')
