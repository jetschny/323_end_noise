...
out_grid_file="bcn_road_focalstats50"
plot_switch=True
write_switch=True
clip_switch=True
...
filename = './BCN_roads_focal_stats_raquel/BCN_roads_focal_50.tif'
...
indexxy = np.where(img_clipped ==65535)
img_clipped[indexxy]=0
